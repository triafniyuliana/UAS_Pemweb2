...
<head>
    <meta charset="UTF-8">
    <title>Semua Produk - TasMu Store</title>
...
<body class="font-['Poppins'] bg-gray-50 h-full flex flex-col">
    ...
    <main class="flex-grow max-w-7xl mx-auto px-6 py-8 w-full">
        <div class="flex justify-between items-center mb-6">
            ...
            <form action="{{ route('store.products') }}" method="GET" class="hidden md:flex">
                <input type="text" name="q" placeholder="Cari..."
                    class="border border-gray-300 rounded-l px-3 py-1 focus:outline-none focus:ring focus:border-pink-500">
                <button type="submit" class="bg-pink-600 text-white px-3 py-1 rounded-r hover:bg-pink-700">
                    Cari
                </button>
            </form>
        </div>
