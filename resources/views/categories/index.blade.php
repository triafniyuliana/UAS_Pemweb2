            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div x-data="{ show: true }" x-show="show" x-transition
                        class="relative mb-4 p-4 pl-12 bg-green-100 text-green-800 rounded shadow">

                        {{-- Tombol silang merah di kiri atas --}}
                        <button @click="show = false"
                            class="absolute top-1 left-2 text-red-600 text-2xl font-bold leading-none hover:text-red-800 focus:outline-none"
                            aria-label="Tutup">
                            &times;
                        </button>
